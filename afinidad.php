...
switch($usr_nivel){
    ...
    case "2":
        ...
        break;
    case "3":
        $sql_paginas = 'SELECT COUNT(*) FROM persona p INNER JOIN municipio m WHERE p.ciudad = m.municipio AND m.id_municipio =  "'.$usr_mun.'" ';
        break;
    case "5":
...
<body>
   ...
   <div class="close_hamb" id="close_hamb"><p>.</p><p>.</p></div>
        ...
        <thead>
            ...
            <!--div class="paginado" align="center">
                <ul class="pagination text-center" id="pagination">
                    ...
                    <?php if(!empty($total_paginas)):
                        for($i=1; $i<=$total_paginas; $i++):  
                            if($i == 1):?>
                                <li class='active pagina'  id="<?php echo $i;?>"><?php echo $i;?></li> 
                            <?php else:?>
                                <li class="pagina" id="<?php echo $i;?>"><?php echo $i;?></li>
                            <?php endif;?>      
                    <?php endfor;endif;?>
            ...
            <div class="info_persona" id="info_persona">
                <div class="cont_info">
                    ...
                    <div id="datos_persona">
                        ...
                        <input value="1" style="display: none" type="text" id="input_tipo" name="tipo" readonly />
                        ...
                        <div class="datos_persona">
                            <label for="info_cve">Clave de elector</label>
                            <p class="info" id="info_cve"></p>
                        </div>
                        
                        <div class="datos_persona">
                            <label for="info_cve">C.U.R.P.</label>
                            <p class="info" id="info_curp"></p>
                        </div>
                        
                        <div class="datos_persona">
                            <label for="info_cve">Facebok</label>
                            <p class="info" id="info_fb"></p>
                        </div>
                        
                        <div class="datos_persona">
                            <label for="info_curp">Teléfono</label>
                    ...
                    <div class="btns_persona" id="btns_persona">
    ...
    $(document).ready(function(){
        ...
        $('#menu_afinidad').addClass("menu_seleccion");
        ...
        function cargaPersonas(){
            $.post('ajax/personas_temp.php',{flag: 1 }, function(data){
                console.log(data);
        ...
        function showInfoPersona(row){
            ...
            $.post("ajax/persona_unico.php", { persona: row.id }, function(data){
                ...
                if(json['id_promotor'] == "8" && (<?php echo $usr_nivel;?> != "8" && <?php echo $usr_nivel;?> != "1" && <?php echo $usr_nivel;?> != "2" && <?php echo $usr_nivel;?> != "3")) {
                    $('#btns_persona').hide();
                } else {
                    $('#btns_persona').show();
                }
