...
if(!$con){
    ...
    foreach($coordenadas as $coordenada){
        $domicilio = $coordenada['calle_num'].', '.$coordenada['colonia'].', '.$coordenada['ciudad'].', '.$coordenada['estado'];
    
    $nombre_completo = $coordenada['nombre'].' '.$coordenada['ap_pat'].' '.$coordenada['ap_mat'];
    
        
        $coord = [
            0 => $nombre_completo.' '.$domicilio,
            1 => $coordenada['lat'],
            2 => $coordenada['lng'],
            3 => $coordenada['afiliacion']
        ];
